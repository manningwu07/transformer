...
if __name__ == "__main__":
    encode_file_gptstyle("data/raw/wiki_val.txt", "data/test/wiki_val_ids", seq_len=Config.max_len)
    print("Done with wiki val (gpt-style)")
    encode_file_gptstyle("data/raw/wiki_eval.txt", "data/test/wiki_eval_ids", seq_len=Config.max_len)
